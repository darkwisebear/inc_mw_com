...
///! This is the "generated" part for the BigData proxy. Its main purpose is to provide the imports
...
extern "C" {
    ...
    fn mw_com_gen_ProxyWrapperClass_mw_com_test_BigData_create(
        handle: &proxy_bridge_rs::HandleType,
    ) -> *mut proxy_bridge_rs::ProxyWrapperClass;
    fn mw_com_gen_ProxyWrapperClass_mw_com_test_BigData_delete(
        proxy: *mut proxy_bridge_rs::ProxyWrapperClass,
    );
    // The following function is per-event per-proxy.
    fn mw_com_gen_ProxyWrapperClass_mw_com_test_BigData_map_api_lanes_stamped_get(
        proxy: *mut proxy_bridge_rs::ProxyWrapperClass,
    ...
    //Skeleton
    fn mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_create(
        instance_specifier: *const proxy_bridge_rs::NativeInstanceSpecifier,
    ) -> *mut proxy_bridge_rs::SkeletonWrapperClass;
    fn mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_map_api_lanes_stamped_get(
        skeleton: *mut proxy_bridge_rs::SkeletonWrapperClass,
    ) -> *mut proxy_bridge_rs::SkeletonEvent<MapApiLanesStamped>;
    fn mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_delete(
        skeleton: *mut proxy_bridge_rs::SkeletonWrapperClass,
    );
    fn mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_offer(
        skeleton: *mut proxy_bridge_rs::SkeletonWrapperClass,
    ) -> bool;

    fn mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_stop_offer(
        skeleton: *mut proxy_bridge_rs::SkeletonWrapperClass,
    );

    fn mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_map_api_lanes_stamped_send(
        event: *mut proxy_bridge_rs::SkeletonEvent<MapApiLanesStamped>,
        sample: *mut MapApiLanesStamped,
    ) -> bool;
}
...
pub type MapApiLanesStampedEvent =
    proxy_bridge_rs::ProxyEvent<MapApiLanesStamped, proxy_bridge_rs::ProxyManager<BigDataProxy>>;
...
/// wish to do so.
pub struct BigDataProxy {
    pub map_api_lanes_stamped: MapApiLanesStampedEvent,
}

impl proxy_bridge_rs::ProxyOps for BigDataProxy {
    fn create(handle: &proxy_bridge_rs::HandleType) -> *mut proxy_bridge_rs::ProxyWrapperClass {
        unsafe { mw_com_gen_ProxyWrapperClass_mw_com_test_BigData_create(handle) }
    }

    unsafe fn delete(proxy: *mut proxy_bridge_rs::ProxyWrapperClass) {
        unsafe {
            mw_com_gen_ProxyWrapperClass_mw_com_test_BigData_delete(proxy);
        }
    }
}
...
impl BigDataProxy {
    ...
    fn map_api_lanes_stamped(
        manager: proxy_bridge_rs::ProxyManager<BigDataProxy>,
    ) -> proxy_bridge_rs::ProxyEvent<MapApiLanesStamped, proxy_bridge_rs::ProxyManager<BigDataProxy>>
    {
        unsafe {
    ...
    /// handle.
    pub fn new(handle: &proxy_bridge_rs::HandleType) -> proxy_bridge_rs::SkeletonResult<Self> {
        let proxy_manager = proxy_bridge_rs::ProxyManager::<BigDataProxy>::new(handle)?;
        Ok(Self {
...
pub struct MapApiLanesStampedSkeletonEvent<S: proxy_bridge_rs::OfferState> {
    event: *mut proxy_bridge_rs::SkeletonEvent<MapApiLanesStamped>,
    skeleton: Arc<BigDataSkeletonLifecycleWrapper>,
    marker: std::marker::PhantomData<S>,
}

impl MapApiLanesStampedSkeletonEvent<proxy_bridge_rs::Offered> {
    pub fn send(
        &self,
        mut stamped_data: MapApiLanesStamped,
    ) -> proxy_bridge_rs::SkeletonResult<()> {
        // SAFETY: calling FFI functionalities
        unsafe {
            proxy_bridge_rs::send_skeleton_event(|| {
                mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_map_api_lanes_stamped_send(
                    self.event,
                    &mut stamped_data,
                )
            })
...
pub struct Events<S: proxy_bridge_rs::OfferState> {
    pub map_api_lanes_stamped: MapApiLanesStampedSkeletonEvent<S>,
}

// we need to find a better name for this
// structure exists so we can move the proxy_birdge_rs::SkeletonWrapper
struct BigDataSkeletonLifecycleWrapper {
    skeleton_wrapper: *mut proxy_bridge_rs::SkeletonWrapperClass,
}

impl Drop for BigDataSkeletonLifecycleWrapper {
    fn drop(&mut self) {
        // SAFETY: calling FFI functionalities
        unsafe {
            mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_delete(self.skeleton_wrapper);
        }
    }
}

pub struct BigDataSkeleton<S: proxy_bridge_rs::OfferState> {
    skeleton: Arc<BigDataSkeletonLifecycleWrapper>,
    pub events: Events<S>,
}

impl BigDataSkeleton<proxy_bridge_rs::UnOffered> {
    pub fn new(
        instance_specifier: &proxy_bridge_rs::InstanceSpecifier,
    ) -> proxy_bridge_rs::SkeletonResult<Self> {
        // SAFETY: calling FFI functionalities
        unsafe {
            let skeleton_wrapper = mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_create(
                instance_specifier.as_native(),
            );
            let skeleton = Arc::new(BigDataSkeletonLifecycleWrapper { skeleton_wrapper });
            let map_api_lanes_stamped =
                mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_map_api_lanes_stamped_get(
                    skeleton_wrapper,
                );
            let map_api_lanes_stamped = MapApiLanesStampedSkeletonEvent {
                event: map_api_lanes_stamped,
    ...
    pub fn offer_service(
        self,
    ) -> proxy_bridge_rs::SkeletonResult<BigDataSkeleton<proxy_bridge_rs::Offered>> {
        // SAFETY: calling FFI functionalities
        unsafe {
            if mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_offer(
                self.skeleton.skeleton_wrapper,
            ) {
                return Ok(BigDataSkeleton {
                    skeleton: self.skeleton.clone(),
                    events: Events {
                        map_api_lanes_stamped: MapApiLanesStampedSkeletonEvent {
                            event: self.events.map_api_lanes_stamped.event,
                            skeleton: self.skeleton.clone(),
                            marker: Default::default(),
                        },
                    },
...
impl BigDataSkeleton<proxy_bridge_rs::Offered> {
    pub fn stop_offer_service(self) -> BigDataSkeleton<proxy_bridge_rs::UnOffered> {
        // SAFETY: calling FFI functionalities
        unsafe {
            mw_com_gen_SkeletonWrapperClass_mw_com_test_BigData_stop_offer(
                self.skeleton.skeleton_wrapper,
            );
            BigDataSkeleton {
                skeleton: self.skeleton.clone(),
